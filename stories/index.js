...
storiesOf("Button", module)
  ...
  .add("Wednesday", () => (
    ...
    storiesOf("InterviewerListItem", module)
      ...
      .add("Confirm", () => <Confirm  message="Delete the appointement?" onConfirm={action("onConfirm")} onCancel={action("onCancel")} />)
      .add("Status", () => <Status message="Deleting" />)
      .add("Error", () => <Error message="Could not delete appointment" onClose={action("onClose")} />)
      .add("Form edit", () => <Form student="moi" interviewer={1} interviewers={interviewers} onSave={action("onSave")} onCancel={action("onCancel")} />)
